...
/**
 * CRI-O 1.22 Debian 11.
 *
 * @author Erwin Müller, erwin.mueller@deventm.de
 * @since 1.0
 */
@Slf4j
class Crio_1_22_Debian_11 extends ScriptBase {

    @Inject
    Crio_1_22_Debian_11_Properties propertiesProvider

    Upstream_Crio_Debian_11 upstreamCrio

    Crio_Crio_1_22_Debian_11 debianCrio
    ...
    @Inject
    void setUpstreamCrioDebianFactory(Upstream_Crio_Debian_11_Factory factory) {
        this.upstreamCrio = factory.create scriptsRepository, service, target, threads, scriptEnv
    }

    @Inject
    void setCrioDebianFactory(Crio_Crio_1_22_Debian_11_Factory factory) {
        this.debianCrio = factory.create scriptsRepository, service, target, threads, scriptEnv
    }

    @Override
    String getSystemName() {
        Crio_1_22_Debian_11_Service.SYSTEM_NAME
    }

    @Override
    String getSystemVersion() {
        Crio_1_22_Debian_11_Service.SYSTEM_VERSION
    }
