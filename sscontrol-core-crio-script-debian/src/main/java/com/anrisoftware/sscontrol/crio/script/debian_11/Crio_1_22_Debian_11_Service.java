...
/**
 * CRI-O 1.22 Debian 11 script service.
 *
 * @author Erwin Müller {@literal <erwin.mueller@deventm.de>}
 * @version 1.0
 */
public class Crio_1_22_Debian_11_Service implements HostServiceScriptFactory {

    public static final String SYSTEM_VERSION = "11";

    public static final String SYSTEM_NAME = "debian";

    @Inject
    private Crio_1_22_Debian_11_Factory scriptFactory;
