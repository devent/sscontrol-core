...
public class RestoreLinuxModule extends AbstractModule {
    ...
    protected void configure() {
        install(new FactoryModuleBuilder().implement(HostServiceScript.class, RestoreLinux.class)
                .build(RestoreLinuxFactory.class));
        install(new FactoryModuleBuilder().implement(BackupWorker.class, RestoreWorkerImpl.class)
