...
import com.anrisoftware.sscontrol.nfs.service.NfsImplFactory
...
abstract class AbstractNfsRunnerTest extends AbstractRunnerTestBase {
    ...
    @Inject
    Nfs_1_3_Debian_11_Factory nfsDebianFactory
    ...
    HostServices putServices(HostServices services) {
        ...
        services.putAvailableScriptService 'nfs-1.3/debian/11', nfsDebianFactory
        return services
    }
