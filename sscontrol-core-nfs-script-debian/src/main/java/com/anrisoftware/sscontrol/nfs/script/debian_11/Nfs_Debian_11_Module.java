 ...
 * @version 1.0
 */
public class Nfs_Debian_11_Module extends AbstractModule {

    @Override
    protected void configure() {
        install(new FactoryModuleBuilder().implement(HostServiceScript.class, Nfs_1_3_Impl.class)
                .build(Nfs_1_3_Factory.class));
        install(new FactoryModuleBuilder().implement(HostServiceScript.class, Nfs_1_3_Debian_11.class)
                .build(Nfs_1_3_Debian_11_Factory.class));
