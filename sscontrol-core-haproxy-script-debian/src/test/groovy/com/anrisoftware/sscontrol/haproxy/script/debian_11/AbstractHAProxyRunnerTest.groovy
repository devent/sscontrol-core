...
import com.anrisoftware.sscontrol.haproxy.service.HAProxyImplFactory
 ...
 * @since 1.0
 */
abstract class AbstractHAProxyRunnerTest extends AbstractRunnerTestBase {
    ...
    @Inject
    HAProxy_2_x_Debian_11_Factory haproxyDebianFactory
    ...
    HostServices putServices(HostServices services) {
        ...
        services.putAvailableScriptService 'haproxy-2.x/debian/11', haproxyDebianFactory
        return services
    }
    ...
    List getAdditionalModules() {
        ...
        modules.addAll HAProxyModules.getAdditionalModules()
        modules
    }
