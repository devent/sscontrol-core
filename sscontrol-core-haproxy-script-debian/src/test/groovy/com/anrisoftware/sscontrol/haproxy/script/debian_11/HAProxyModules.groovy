...
import com.anrisoftware.sscontrol.haproxy.script.debian_11.HAProxy_Debian_11_Module
import com.anrisoftware.sscontrol.haproxy.script.haproxy_2_x.HAProxy_2_x_Module
import com.anrisoftware.sscontrol.haproxy.service.HAProxyModule
 ...
 * @version 1.0
 */
class HAProxyModules {

    static List getAdditionalModules() {
        [
            new SshModule(),
            new HAProxyModule(),
            new HAProxy_Debian_11_Module(),
            new HAProxy_2_x_Module(),
