 ...
 */
@Slf4j
abstract class GrubUtils {

    final HostServiceScript script

    protected GrubUtils(HostServiceScript script) {
        this.script = script
    }
    ...
    /**
     * Attaches the command to the default Linux command line.
     */
    def attachGrubCommandLine(String command) {
        attachGrubCommandLine([command])
    }

    /**
     * Attaches the commands to the default Linux command line.
     */
    abstract attachGrubCommandLine(List commands)
}
