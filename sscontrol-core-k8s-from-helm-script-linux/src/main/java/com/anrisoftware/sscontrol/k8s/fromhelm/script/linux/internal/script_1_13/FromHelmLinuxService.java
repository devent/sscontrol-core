 ...
 * @version 1.0
 */
public class FromHelmLinuxService implements HostServiceScriptService {

    static final String SERVICE_NAME = "from-helm";
    ...
    @Inject
    private FromHelmLinuxFactory scriptFactory;
