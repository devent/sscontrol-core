...
public class UserPasswordImpl implements UserPassword {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("name", name).append("password", password).toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return new EqualsBuilder().append(name, rhs.name).append(password, rhs.password).isEquals();
    }
}
