...
abstract class ScriptBase extends Script implements HostServiceScript {
     ...
     * Finds and creates the script.
     */
    HostServiceScript createScript(HostServiceScriptFactory scriptService, HostService service) {
     ...
     * Finds the script.
     */
    public <T extends HostServiceScriptFactory> T findScriptService(String name, SystemInfo system=target.system) {
     ...
     * Finds the script.
     */
    public <T extends HostServiceScriptFactory> T findScriptService(String name, String systemName) {
     ...
     */
    public <T extends HostServiceFactory> T findAvailableService(String name) {
