...
import com.anrisoftware.sscontrol.k8s.cluster.script.linux.cluster_1_2x.K8sClusterLinuxFactory
...
import com.anrisoftware.sscontrol.k8s.script.control_1_2x.debian_11.K8sControlDebianFactory
 ...
 * @since 1.0
 */
abstract class AbstractControlRunnerTest extends AbstractRunnerTestBase {

    static final Map robobeetestCerts = [
        ca: [
            cert: AbstractControlRunnerTest.class.getResource('robobee_test_kube_ca.pem'),
            key: AbstractControlRunnerTest.class.getResource('robobee_test_kube_key.pem'),
        ],
        etcd: [
            ca: AbstractControlRunnerTest.class.getResource('robobee_test_etcd_ca.pem'),
            cert: AbstractControlRunnerTest.class.getResource('robobee_test_etcd_kube_0_cert.pem'),
            key: AbstractControlRunnerTest.class.getResource('robobee_test_etcd_kube_0_key.pem'),
        ]
    ]
    ...
    @Inject
    K8sControlDebianFactory scriptFactory
    ...
    HostServices putServices(HostServices services) {
        ...
        services.putAvailableScriptService 'k8s-control/debian/11', scriptFactory
        return services
    }
