...
''',
            ...
            expected: { Map args ->
                ...
                assertFileResource K8sControlScriptTest, new File(gen, "kubelet.service.d"), "20-robobee.conf", "${args.test.name}_kubelet_extra_conf_expected.txt"
            },
        ]
        doTest test
    }
...
''',
            ...
            expected: { Map args ->
                File dir = args.dir
                File gen = args.test.generatedDir
                assertFileResource K8sControlScriptTest, dir, "sed.out", "${args.test.name}_sed_expected.txt"
            },
        ]
        doTest test
    }
