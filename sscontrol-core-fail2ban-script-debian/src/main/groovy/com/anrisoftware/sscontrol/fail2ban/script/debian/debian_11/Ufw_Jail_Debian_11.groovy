 ...
 * @version 1.0
 */
class Ufw_Jail_Debian_11 extends Ufw_Jail_0_11_Debian {

    @Inject
    Ufw_Jail_Debian_11_Properties debianPropertiesProvider
    ...
    void setTemplatesFactory(TemplatesFactory factory) {
        debianTemplates = factory.create 'Ufw_Fail2ban_Debian_11_Templates'
    }

    @Inject
    void setTextsFactory(TextsFactory factory) {
        debianTexts = factory.create 'Ufw_Fail2ban_Debian_11_Texts'
    }
