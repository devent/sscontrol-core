 ...
 * @version 1.0
 */
public class Fail2ban_Debian_11_Module extends AbstractModule {
    ...
    protected void configure() {
        ...
        install(new FactoryModuleBuilder().implement(HostServiceScript.class, Ufw_Jail_Debian_11.class)
                .build(Ufw_Jail_Debian_11_Factory.class));
    }
