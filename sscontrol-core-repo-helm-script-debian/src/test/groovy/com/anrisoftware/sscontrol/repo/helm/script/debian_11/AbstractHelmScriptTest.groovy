 ...
 * @version 1.0
 */
abstract class AbstractHelmScriptTest extends AbstractHelmRunnerTest {

    static final URL helmCommand = AbstractHelmScriptTest.class.getResource('helm.txt')

    static final URL helmGrepCommand = AbstractHelmScriptTest.class.getResource('helm_grep.txt')
