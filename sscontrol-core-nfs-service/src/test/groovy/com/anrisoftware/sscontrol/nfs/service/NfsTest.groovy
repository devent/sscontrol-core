...
service "nfs", version: "1.3" with {
    ...
    export dir: "/nfsfileshare/1" with {
        host << "andrea-node-3.muellerpublic.de"
        host name: "andrea-node-4.muellerpublic.de", options: "rw,sync,no_root_squash"
    }
}
''',
            expected: { HostServices services ->
                ...
                assert collectd.exports.size() == 2
                ...
                assert collectd.exports[1].dir == '/nfsfileshare/1'
                assert collectd.exports[1].hosts.size() == 2
                assert collectd.exports[1].hosts[0].name == 'andrea-node-3.muellerpublic.de'
                assert collectd.exports[1].hosts[0].options == null
                assert collectd.exports[1].hosts[1].name == 'andrea-node-4.muellerpublic.de'
                assert collectd.exports[1].hosts[1].options == 'rw,sync,no_root_squash'
            },
        ]
        doTest test
    }
